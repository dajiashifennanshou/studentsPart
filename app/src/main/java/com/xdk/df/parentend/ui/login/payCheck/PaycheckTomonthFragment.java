 ...
 */
public class PaycheckTomonthFragment extends BaseFragment {
    private View view;
    ...
    private void initData() {
        try {
            ...
            if (flag){
                ...
                listView.setAdapter(new PayCheckItemAdapter(context,moneyDeatils,"month"));
            }else{
                listView.setVisibility(View.GONE);
                notingTx.setVisibility(View.VISIBLE);
            }
    ...
    public void initView() {
        ...
        String sql = "select * from MoneyDetail where accountid = '" + SharedPreferenceHelper.getCurrentUser(context).getAccountid() + "'and schoolcode = '" + SharedPreferenceHelper.getCurrentUser(context).getSchoolcode() + "' a" +
                "nd happendate Between  '" + new SimpleDateFormat("yyyy-MM-dd").format(getCurrentMonthStartTime()) + "' and '"+new SimpleDateFormat("yyyy-MM-dd").format(getCurrentMonthEndTime())+"'";
