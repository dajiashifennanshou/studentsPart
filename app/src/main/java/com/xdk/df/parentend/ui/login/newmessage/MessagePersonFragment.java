 ...
 */
public class MessagePersonFragment extends BaseFragment implements View.OnClickListener {
    private View view;
    ...
    public void initView() {
        ...
        same = "select MAX(noticeid) from v_notice where  schoolcode = '" + user.getSchoolcode() + "'and accountid = '" + user.getAccountid() + "' and validdate >= '" +
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.message_class_fragment_next:
                String sa = "select MIN(noticeid) from v_notice where  schoolcode = '" + user.getSchoolcode() + "' and accountid = '" + user.getAccountid() + "' and validdate >= '" +
